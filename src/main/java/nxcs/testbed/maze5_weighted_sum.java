...
//    private int count;
//
//    final static Logger logger = Logger.getLogger(maze5_weighted_sum.class);
//
//
//    /**
...
////     * @throws IOException On standard IO problems
////     */
////    public maze5_weighted_sum(File f) throws IOException {
...
//                        //maze5_weighted_sum maze = new maze5_weighted_sum("data/maze5.txt");
//                        NXCS nxcs = new NXCS(this, params);
//
//
//                        //initialize MOEAD
...
//    }
//
//    private ArrayList<ArrayList<StepSnapshot>> traceReward(int exp_repeat, int timeStamp, maze5_weighted_sum maze, NXCS nxcs,
...
//    }
//
//    public void printOpenLocationClassifiers(int timestamp, maze5_weighted_sum maze, NXCS nxcs, double[] weight, double obj_r1) {
...
//    }
//
//    private ArrayList<StepSnapshot> GetTestingPAResultInCSV(int experiment_num, int timestamp, maze5_weighted_sum maze, NXCS nxcs, double[] weight, double obj_r1, int[] ActionSelect) {
//
...
//    }
//
//    private ArrayList<StepSnapshot> GetTrainingPAResultInCSV(int experiment_num, int timestamp, maze5_weighted_sum maze, NXCS nxcs, double[] weight, double obj_r1) {
//
//        ArrayList<StepSnapshot> PAresult = new ArrayList<StepSnapshot>();
//
//
