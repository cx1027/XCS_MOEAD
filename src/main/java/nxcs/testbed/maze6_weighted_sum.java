...
public class maze6_weighted_sum extends MazeBase {
    ...
    public Hashtable<String, Boolean> getOpenLocationExpectPaths(){
        ...
        ht.put("(1-1)-(7-1)-10", true);
        ht.put("(1-1)-(1-7)-6", true);
        ht.put("(1-2)-(1-7)-5", true);
        ht.put("(1-2)-(7-1)-11", true);
        ht.put("(1-3)-(1-7)-4", true);
        ht.put("(1-3)-(7-1)-10", true);
        ht.put("(1-4)-(1-7)-3", true);
        ht.put("(1-4)-(7-1)-9", true);
        ht.put("(1-5)-(1-7)-2", true);
        ht.put("(1-5)-(7-1)-10", true);
        ht.put("(1-6)-(1-7)-1", true);
        ht.put("(1-6)-(7-1)-11", true);
        ht.put("(2-1)-(7-1)-9", true);
        ht.put("(2-1)-(1-7)-7", true);
        ht.put("(2-2)-(7-1)-10", true);
        ht.put("(2-2)-(1-7)-6", true);
        ht.put("(2-4)-(1-7)-4", true);
        ht.put("(2-4)-(7-1)-8", true);
        ht.put("(2-7)-(1-7)-1", true);
        ht.put("(2-7)-(7-1)-11", true);
        ht.put("(3-1)-(7-1)-8", true);
        ht.put("(3-1)-(1-7)-8", true);
        ht.put("(3-3)-(7-1)-6", true);
        ht.put("(3-3)-(1-7)-6", true);
        ...
        ht.put("(3-7)-(7-1)-10", true);
        ht.put("(4-1)-(7-1)-7", true);
        ht.put("(4-1)-(1-7)-9", true);
        ht.put("(4-2)-(7-1)-6", true);
        ht.put("(4-2)-(1-7)-8", true);
        ht.put("(4-3)-(7-1)-5", true);
        ht.put("(4-3)-(1-7)-7", true);
        ht.put("(4-6)-(1-7)-4", true);
        ht.put("(4-6)-(7-1)-8", true);
        ht.put("(4-7)-(1-7)-3", true);
        ht.put("(4-7)-(7-1)-9", true);
        ht.put("(5-1)-(7-1)-8", true);
        ht.put("(5-3)-(7-1)-4", true);
        ht.put("(5-5)-(7-1)-6", true);
        ht.put("(5-5)-(1-7)-6", true);
        ht.put("(5-6)-(7-1)-7", true);
        ht.put("(5-6)-(1-7)-5", true);
        ht.put("(5-7)-(1-7)-4", true);
        ht.put("(5-7)-(7-1)-8", true);
